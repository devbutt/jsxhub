...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-primary bg-opacity-30 pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-4 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  Developing with Javascript Frameworks can be a breeze, please
                  dont get blown away with it.
                </p>
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              All Rights reserved Copyright 2023 Jsxhub
            </p>
          </div>
        </div>
